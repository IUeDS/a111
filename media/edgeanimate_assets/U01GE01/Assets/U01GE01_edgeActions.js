...
console.log("qArray =  "+qArray);qnum=0;totalq=0;cornumber=0;console.log("qnum =  "+qnum);sym.$("Feedback").html("");sym.getSymbol("Feedbackground").stop(0000);sym.getSymbol("Timer").stop(0000);sym.getSymbol("electAni").stop(0000);sym.setVariable("cornumber",0);sym.$("questans").html("0");sym.$("correctans").html("0");sym.$("correct").html("Answer");var mySymbolObject=sym.getSymbol("given");mySymbolObject.stop("negative");var mySymbolObject=sym.getSymbol("question");mySymbolObject.stop(0000);sym.setVariable("p","false");sym.setVariable("n","false");sym.setVariable("z","false");function nextQuest()
{}
sym.stop();});
//Edge binding end
...
if(cornumber==8){sym.$("Feedback").addClass("lti-complete").html("Congratulations! You have met your goal!");sym.$("Next_btn").hide();}else{console.log("not last question");var nbutton=sym.getSymbol("Next_btn");nbutton.$("Text").html("Next");}});
//Edge binding end
...
cornumber++;sym.getSymbol("electAni").play("roll");sym.getSymbol("Feedbackground").stop("correct");sym.$("Feedback").html("Yes, that's correct!");}else if(neg=="wrong"){console.log("false1");sym.getSymbol("electAni").play("left");sym.getSymbol("Feedbackground").stop("wrong");sym.$("Feedback").html("The electron is going in the wrong direction!");cornumber=0;}else{console.log("false2");sym.getSymbol("Feedbackground").stop("wrong");sym.$("failure")[0].play();sym.$("Feedback").html("That electron isn't moving!");sym.$("Feedback").show();sym.$("Feedbackground").show();cornumber=0;if(totalq>8){sym.$("questans").html(cornumber);}}
console.log("qvalue = "+qvalue);if(qvalue==1){sym.stop("a1");}else if(qvalue==2){sym.stop("a2");}else if(qvalue==3){sym.stop("a3");}else if(qvalue==4){sym.stop("a4");}else{console.log("not advancing to qvalue");}});
//Edge binding end
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Next_btn}","mousedown",function(sym,e){sym.$("buttonclick")[0].play();if(totalq==8){cornumber=0;sym.$("correct").html("Consecutive correct:");sym.$("questans").html(cornumber);}
...
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",3750,function(sym,e){console.log("end of animation");sym.getComposition().getStage().$("Feedbackground").stop("correct");sym.getComposition().getStage().$("Feedbackground").show();sym.getComposition().getStage().$("Feedback").show();if(totalq>8){console.log(">8");sym.getComposition().getStage().$("questans").html(cornumber);}
if(cornumber==8){sym.getComposition().getStage().$("applause")[0].play();}else{sym.getComposition().getStage().$("success")[0].play();}
sym.stop();});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",0,function(sym,e){sym.stop();});
//Edge binding end
...
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",5250,function(sym,e){console.log("end of animation");sym.getComposition().getStage().$("failure")[0].play();sym.getComposition().getStage().$("Feedbackground").stop("wrong");sym.getComposition().getStage().$("Feedbackground").show();sym.getComposition().getStage().$("Feedback").show();if(totalq>8){console.log(">8");sym.getComposition().getStage().$("questans").html(cornumber);}
sym.stop();});
//Edge binding end
