...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Pos_btn}","click",function(sym,e){var mySymbolObject=sym.getSymbol("Pos_btn");mySymbolObject.stop("down");var mySymbolObject=sym.getSymbol("question");mySymbolObject.stop("positive");var mySymbolObject=sym.getSymbol("Timer");mySymbolObject.stop();var mySymbolObject=sym.getSymbol("Pos_graphic");mySymbolObject.stop("down");var mySymbolObject=sym.getSymbol("Zero_graphic");mySymbolObject.stop("up");var mySymbolObject=sym.getSymbol("Neg_graphic");mySymbolObject.stop("up");var pos=sym.getVariable("p");if(pos=="true"){sym.getSymbol("electAni").play("roll");sym.getSymbol("Feedbackground").stop("correct");sym.$("Feedback").html("Yes, that's correct!");sym.setVariable("cornumber",sym.getVariable("cornumber")+1);console.log("var test is set at "+sym.getVariable("cornumber"));sym.$("correctans").html(sym.getVariable("cornumber").toString());}else{sym.getSymbol("Feedbackground").stop("wrong");sym.$("Feedback").html("That electron isn't moving!");sym.$("correctans").html("0");sym.setVariable("cornumber",0);}
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Zero_btn}","click",function(sym,e){var mySymbolObject=sym.getSymbol("Zero_btn");mySymbolObject.stop("down");var mySymbolObject=sym.getSymbol("question");mySymbolObject.stop("zero");var mySymbolObject=sym.getSymbol("Timer");mySymbolObject.stop();var mySymbolObject=sym.getSymbol("Pos_graphic");mySymbolObject.stop("up");var mySymbolObject=sym.getSymbol("Zero_graphic");mySymbolObject.stop("down");var mySymbolObject=sym.getSymbol("Neg_graphic");mySymbolObject.stop("up");var zero=sym.getVariable("z");if(zero=="true"){sym.setVariable("cornumber",sym.getVariable("cornumber")+1);console.log("var test is set at "+sym.getVariable("cornumber"));sym.$("correctans").html(sym.getVariable("cornumber").toString());sym.getSymbol("electAni").play("roll");sym.getSymbol("Feedbackground").stop("correct");sym.$("Feedback").html("Yes, that's correct!");}else{sym.getSymbol("Feedbackground").stop("wrong");sym.$("Feedback").html("That electron isn't moving!");sym.$("correctans").html("0");sym.setVariable("cornumber",0)}
console.log("qvalue = "+qvalue);if(qvalue==1){sym.stop("a1");}else if(qvalue==2){sym.stop("a2");}else if(qvalue==3){sym.stop("a3");}else if(qvalue==4){sym.stop("a4");}else{console.log("not advancing to qvalue");}});
//Edge binding end
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Neg_btn}","click",function(sym,e){var mySymbolObject=sym.getSymbol("Neg_btn");mySymbolObject.stop("down");var mySymbolObject=sym.getSymbol("question");mySymbolObject.stop("negative");var mySymbolObject=sym.getSymbol("Timer");mySymbolObject.stop();var mySymbolObject=sym.getSymbol("Pos_graphic");mySymbolObject.stop("up");var mySymbolObject=sym.getSymbol("Zero_graphic");mySymbolObject.stop("up");var mySymbolObject=sym.getSymbol("Neg_graphic");mySymbolObject.stop("down");var neg=sym.getVariable("n");if(neg=="true"){sym.setVariable("cornumber",sym.getVariable("cornumber")+1);console.log("var test is set at "+sym.getVariable("cornumber"));sym.$("correctans").html(sym.getVariable("cornumber").toString());sym.getSymbol("electAni").play("roll");sym.getSymbol("Feedbackground").stop("correct");sym.$("Feedback").html("Yes, that's correct!");}else{sym.getSymbol("Feedbackground").stop("wrong");sym.$("Feedback").html("That electron isn't moving!");sym.$("correctans").html("0");sym.setVariable("cornumber",0)}
console.log("qvalue = "+qvalue);if(qvalue==1){sym.stop("a1");}else if(qvalue==2){sym.stop("a2");}else if(qvalue==3){sym.stop("a3");}else if(qvalue==4){sym.stop("a4");}else{console.log("not advancing to qvalue");}});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_begin}","click",function(sym,e){var mySymbolObject=sym.getSymbol("begin");mySymbolObject.stop("down");sym.play("nextq");});
//Edge binding end
...
console.log("qArray =  "+qArray);qnum=0;totalq=0;console.log("qnum =  "+qnum);sym.$("Feedback").html("");sym.getSymbol("Feedbackground").stop(0000);sym.getSymbol("Timer").stop(0000);sym.getSymbol("electAni").stop(0000);sym.setVariable("cornumber",0);sym.$("questans").html("0");sym.$("correctans").html("0");var mySymbolObject=sym.getSymbol("given");mySymbolObject.stop("negative");var mySymbolObject=sym.getSymbol("question");mySymbolObject.stop(0000);sym.setVariable("p","false");sym.setVariable("n","false");sym.setVariable("z","false");function nextQuest()
{}
sym.stop();});
//Edge binding end
...
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",1750,function(sym,e){sym.getSymbol("Feedbackground").stop("wrong");sym.$("Feedback").html("Feedback: Time's up!");sym.$("correctans").html("0");sym.setVariable("cornumber",0)
if(qvalue==1){sym.stop("a1");}else if(qvalue==2){sym.stop("a2");}else if(qvalue==3){sym.stop("a3");}else if(qvalue==4){sym.stop("a4");}else{}});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",1500,function(sym,e){console.log("at a1");sym.$("questans").html(totalq);var correct=sym.getVariable("cornumber")
if(correct==8){sym.$("Feedback").html("Congratulation! You have met your goal!");sym.$("Next_btn").hide();}else if(totalq==24){var nbutton=sym.getSymbol("Next_btn");nbutton.$("Text").html("Start Over");sym.$("Feedback").html("You have not met the goal after 24 attempts. It is strongly recommended that you review the module content before trying this game again.");}else{console.log("not last question");var nbutton=sym.getSymbol("Next_btn");nbutton.$("Text").html("Next");}});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",2500,function(sym,e){console.log("at a2");sym.$("questans").html(totalq);var correct=sym.getVariable("cornumber")
if(correct==8){sym.$("Feedback").html("Congratulation! You have met your goal!");sym.$("Next_btn").hide();}else if(totalq==24){var nbutton=sym.getSymbol("Next_btn");nbutton.$("Text").html("Start Over");sym.$("Feedback").html("You have not met the goal after 24 attempts. It is strongly recommended that you review the module content before trying this game again.");}else{console.log("not last question");var nbutton=sym.getSymbol("Next_btn");nbutton.$("Text").html("Next");}});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",3500,function(sym,e){console.log("at a3");sym.$("questans").html(totalq);var correct=sym.getVariable("cornumber")
if(correct==8){sym.$("Feedback").html("Congratulation! You have met your goal!");sym.$("Next_btn").hide();}else if(totalq==24){var nbutton=sym.getSymbol("Next_btn");nbutton.$("Text").html("Start Over");sym.$("Feedback").html("You have not met the goal after 24 attempts. It is strongly recommended that you review the module content before trying this game again.");}else{console.log("not last question");var nbutton=sym.getSymbol("Next_btn");nbutton.$("Text").html("Next");}});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",4500,function(sym,e){console.log("at a4");sym.$("questans").html(totalq);var correct=sym.getVariable("cornumber")
if(correct==8){sym.$("Feedback").html("Congratulation! You have met your goal!");sym.$("Next_btn").hide();}else if(totalq==24){var nbutton=sym.getSymbol("Next_btn");nbutton.$("Text").html("Start Over");sym.$("Feedback").html("You have not met the goal after 24 attempts. It is strongly recommended that you review the module content before trying this game again.");}else{console.log("not last question");var nbutton=sym.getSymbol("Next_btn");nbutton.$("Text").html("Next");}});
//Edge binding end
...
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",5000,function(sym,e){console.log("timeline nextq");sym.$("Feedback").html("");sym.getSymbol("electAni").play("drop");sym.getSymbol("given").stop(0000);sym.getSymbol("question").stop(0000);sym.getSymbol("Feedbackground").stop(0000);sym.getSymbol("Pos_graphic").stop(0000);sym.getSymbol("Zero_graphic").stop(0000);sym.getSymbol("Neg_graphic").stop(0000);});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",6500,function(sym,e){sym.$("Feedback").html("Go!");console.log("qArray =  "+qArray);console.log("qnum =  "+qnum);qvalue=qArray[qnum.toString()];console.log("nextQuest running"+qvalue);qnum++;totalq++;console.log("qnum =  "+qnum);if(qvalue==1){sym.stop("q1");}else if(qvalue==2){sym.stop("q2");}else if(qvalue==3){sym.stop("q3");}else if(qvalue==4){sym.stop("q4");}else{console.log("if else not working");}});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Pos_btn}","mousedown",function(sym,e){});
//Edge binding end
...
//Edge symbol: 'Timer'
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",1028,function(sym,e){sym.$("countdown").html("9");});
//Edge binding end
...
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",2053,function(sym,e){sym.$("Text2").html("X");});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",0,function(sym,e){sym.$("Text").html("");});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",1000,function(sym,e){sym.$("Text2").html("√");});
//Edge binding end
})("feedbackground");
