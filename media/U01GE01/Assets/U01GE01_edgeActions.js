...
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",3000,function(sym,e){console.log("at q3");sym.getSymbol("question").stop(0000);sym.getSymbol("given").stop("zero");sym.getSymbol("Timer").play(0000);sym.getSymbol("Feedbackground").stop(0000);sym.$("Feedback").html("GO!");sym.setVariable("p","true");sym.setVariable("n","wrong");sym.setVariable("z","false");console.log("qnum =  "+qnum);var p=sym.getVariable("p");var n=sym.getVariable("n");var z=sym.getVariable("z");if(p=="true"){sym.$("Pos_btn").addClass("lti-correct").removeClass("lti-incorrect");}
else{sym.$("Pos_btn").addClass("lti-incorrect").removeClass("lti-correct");}
if(n=="true"){sym.$("Neg_btn").addClass("lti-correct").removeClass("lti-incorrect");}
else{sym.$("Neg_btn").addClass("lti-incorrect").removeClass("lti-correct")}});
//Edge binding end
...
console.log("qArray =  "+qArray);qnum=0;cornumber=0;console.log("qnum =  "+qnum);sym.$("Feedback").html("");sym.getSymbol("Feedbackground").stop(0000);sym.getSymbol("Timer").stop(0000);sym.getSymbol("electAni").stop(0000);sym.$("Next_btn").hide();sym.setVariable("cornumber",0);sym.$("questans").html("0");sym.$("correctans").html("0");var mySymbolObject=sym.getSymbol("given");mySymbolObject.stop("negative");var mySymbolObject=sym.getSymbol("question");mySymbolObject.stop(0000);sym.setVariable("p","false");sym.setVariable("n","false");sym.setVariable("z","false");function nextQuest()
{}
sym.stop();});
//Edge binding end
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Start_btn}","click",function(sym,e){sym.stop(0000);console.log("100");});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",6500,function(sym,e){sym.$("Feedback").html("Go!");console.log("qArray =  "+qArray);console.log("qnum =  "+qnum);qvalue=qArray[qnum.toString()];qnum++;console.log("qnum =  "+qnum);if(qvalue==1){sym.stop("q1");}
else if(qvalue==2){sym.stop("q2");}
else if(qvalue==3){sym.stop("q3");}
else if(qvalue==4){sym.stop("q4");}
else{console.log("if else not working");}});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Pos_btn}","mousedown",function(sym,e){var mySymbolObject=sym.getSymbol("Pos_btn");mySymbolObject.stop("down");sym.$("buttonclick")[0].play();var mySymbolObject=sym.getSymbol("question");mySymbolObject.stop("positive");var mySymbolObject=sym.getSymbol("Timer");mySymbolObject.stop();var mySymbolObject=sym.getSymbol("Pos_graphic");mySymbolObject.stop("down");var mySymbolObject=sym.getSymbol("Zero_graphic");mySymbolObject.stop("up");var mySymbolObject=sym.getSymbol("Neg_graphic");mySymbolObject.stop("up");sym.$("Pos_btn").hide();sym.$("Zero_btn").hide();sym.$("Neg_btn").hide();sym.$("glow").hide();sym.$("Pos_graphic").show();sym.$("Zero_graphic").show();sym.$("Neg_graphic").show();sym.$("Feedbackground").hide();sym.$("Feedback").hide();var pos=sym.getVariable("p");if(pos=="true"){console.log("true");sym.getSymbol("electAni").play("roll");cornumber++;sym.getSymbol("Feedbackground").stop("correct");if(cornumber==8){sym.$("Feedback").html("Congratulations! You have met your goal!");}else{sym.$("Feedback").html("Yes, that's correct!");}}
else if(pos=="wrong"){console.log("false1");sym.getSymbol("electAni").play("left");sym.getSymbol("Feedbackground").stop("wrong");sym.$("Feedback").html("The electron is going in the wrong direction!");cornumber=0;}
else{console.log("false2");sym.getSymbol("Feedbackground").stop("wrong");sym.$("failure1")[0].play();sym.$("Feedback").show();sym.$("Feedbackground").show();sym.$("Feedback").html("That electron isn't moving!");cornumber=0;sym.$("questans").html(cornumber);sym.$("Next_btn").show();}});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Zero_btn}","mousedown",function(sym,e){var mySymbolObject=sym.getSymbol("Zero_btn");mySymbolObject.stop("down");sym.$("buttonclick")[0].play();var mySymbolObject=sym.getSymbol("question");mySymbolObject.stop("zero");var mySymbolObject=sym.getSymbol("Timer");mySymbolObject.stop();var mySymbolObject=sym.getSymbol("Pos_graphic");mySymbolObject.stop("up");var mySymbolObject=sym.getSymbol("Zero_graphic");mySymbolObject.stop("down");var mySymbolObject=sym.getSymbol("Neg_graphic");mySymbolObject.stop("up");sym.$("Pos_btn").hide();sym.$("Zero_btn").hide();sym.$("Neg_btn").hide();sym.$("glow").hide();sym.$("Pos_graphic").show();sym.$("Zero_graphic").show();sym.$("Neg_graphic").show();sym.$("Feedbackground").hide();sym.$("Feedback").hide();var zero=sym.getVariable("z");if(zero=="true"){console.log("true");cornumber++;sym.getSymbol("electAni").play("roll");sym.getSymbol("Feedbackground").stop("correct");if(cornumber==8){sym.$("Feedback").html("Congratulations! You have met your goal!");}else{sym.$("Feedback").html("Yes, that's correct!");}}
else if(zero=="wrong"){console.log("false1");sym.getSymbol("electAni").play("left");sym.getSymbol("Feedbackground").stop("wrong");sym.$("Feedback").html("The electron is going in the wrong direction!");cornumber=0;}
else{console.log("false2");sym.getSymbol("Feedbackground").stop("wrong");sym.$("failure1")[0].play();sym.$("Feedback").show();sym.$("Feedbackground").show();sym.$("Feedback").html("That electron isn't moving!");cornumber=0;sym.$("questans").html(cornumber);sym.$("Next_btn").show();}});
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Neg_btn}","mousedown",function(sym,e){var mySymbolObject=sym.getSymbol("Neg_btn");mySymbolObject.stop("down");sym.$("buttonclick")[0].play();var mySymbolObject=sym.getSymbol("question");mySymbolObject.stop("negative");var mySymbolObject=sym.getSymbol("Timer");mySymbolObject.stop();var mySymbolObject=sym.getSymbol("Pos_graphic");mySymbolObject.stop("up");var mySymbolObject=sym.getSymbol("Zero_graphic");mySymbolObject.stop("up");var mySymbolObject=sym.getSymbol("Neg_graphic");mySymbolObject.stop("down");sym.$("Pos_btn").hide();sym.$("Zero_btn").hide();sym.$("Neg_btn").hide();sym.$("glow").hide();sym.$("Pos_graphic").show();sym.$("Zero_graphic").show();sym.$("Neg_graphic").show();console.log("hiding buttons");var neg=sym.getVariable("n");sym.$("Feedbackground").hide();sym.$("Feedback").hide();if(neg=="true"){console.log("true");var attempts=sym.getVariable("totalq")
cornumber++;sym.getSymbol("electAni").play("roll");sym.getSymbol("Feedbackground").stop("correct");if(cornumber==8){sym.$("Feedback").html("Congratulations! You have met your goal!");}else{sym.$("Feedback").html("Yes, that's correct!");}}
else if(neg=="wrong"){console.log("false1");sym.getSymbol("electAni").play("left");sym.getSymbol("Feedbackground").stop("wrong");sym.$("Feedback").html("The electron is going in the wrong direction!");cornumber=0;}
else{console.log("false2");sym.getSymbol("Feedbackground").stop("wrong");sym.$("failure1")[0].play();sym.$("Feedback").html("That electron isn't moving!");sym.$("Feedback").show();sym.$("Feedbackground").show();cornumber=0;sym.$("questans").html(cornumber);sym.$("Next_btn").show();}});
//Edge binding end
...
//Edge binding end
Symbol.bindElementAction(compId,symbolName,"${_Next_btn}","mousedown",function(sym,e){sym.$("buttonclick")[0].play();sym.$("Next_btn").hide();if(qnum==4){sym.stop("reorder");}else{sym.play("nextq");}});
//Edge binding end
...
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",1000,function(sym,e){console.log("at q1");sym.getSymbol("question").stop(0000);sym.getSymbol("given").stop("negative");sym.getSymbol("Timer").play(0000);sym.getSymbol("Feedbackground").stop(0000);sym.$("Feedback").html("GO!");sym.setVariable("p","true");sym.setVariable("n","false");sym.setVariable("z","true");console.log("qnum =  "+qnum);sym.stop();var p=sym.getVariable("p");var n=sym.getVariable("n");var z=sym.getVariable("z");if(p=="true"){sym.$("Pos_btn").addClass("lti-correct").removeClass("lti-incorrect");}
else{sym.$("Pos_btn").addClass("lti-incorrect").removeClass("lti-correct");}
if(n=="true"){sym.$("Neg_btn").addClass("lti-correct").removeClass("lti-incorrect");}
else{sym.$("Neg_btn").addClass("lti-incorrect").removeClass("lti-correct")}
...
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",1750,function(sym,e){sym.getSymbol("Feedbackground").stop("wrong");sym.$("Feedback").html("Time's up!");sym.$("questans").html("0");sym.$("failure1")[0].play();cornumber=0;sym.$("Next_btn").show();console.log("var test is set at "+sym.getVariable("cornumber"));if(qvalue==1){sym.stop("a1");}
else if(qvalue==2){sym.stop("a2");}
else if(qvalue==3){sym.stop("a3");}
else if(qvalue==4){sym.stop("a4");}
else{}});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",2000,function(sym,e){console.log("at q2");sym.getSymbol("question").stop(0000);sym.getSymbol("given").stop("zero");sym.getSymbol("Timer").play(0000);sym.getSymbol("Feedbackground").stop(0000);sym.$("Feedback").html("GO!");sym.setVariable("p","wrong");sym.setVariable("n","true");sym.setVariable("z","false");console.log("qnum =  "+qnum);var p=sym.getVariable("p");var n=sym.getVariable("n");var z=sym.getVariable("z");if(p=="true"){sym.$("Pos_btn").addClass("lti-correct").removeClass("lti-incorrect");}else{sym.$("Pos_btn").addClass("lti-incorrect").removeClass("lti-correct");}
...
if(z=="true"){sym.$("Zero_btn").addClass("lti-correct").removeClass("lti-incorrect");}else{sym.$("Zero_btn").addClass("lti-incorrect").removeClass("lti-correct")}});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",4000,function(sym,e){console.log("at q4");sym.getSymbol("question").stop(0000);sym.getSymbol("given").stop("positive");sym.getSymbol("Timer").play(0000);sym.getSymbol("Feedbackground").stop(0000);sym.$("Feedback").html("GO!");sym.setVariable("p","false");sym.setVariable("n","true");sym.setVariable("z","true");console.log("qnum =  "+qnum);var p=sym.getVariable("p");var n=sym.getVariable("n");var z=sym.getVariable("z");if(p=="true"){sym.$("Pos_btn").addClass("lti-correct").removeClass("lti-incorrect");}else{sym.$("Pos_btn").addClass("lti-incorrect").removeClass("lti-correct");}
if(n=="true"){sym.$("Neg_btn").addClass("lti-correct").removeClass("lti-incorrect");}else{sym.$("Neg_btn").addClass("lti-incorrect").removeClass("lti-correct")}
if(z=="true"){sym.$("Zero_btn").addClass("lti-correct").removeClass("lti-incorrect");}else{sym.$("Zero_btn").addClass("lti-incorrect").removeClass("lti-correct")}});
//Edge binding end
...
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",3750,function(sym,e){console.log("end of animation");sym.getComposition().getStage().$("Feedbackground").stop("correct");sym.getComposition().getStage().$("Feedbackground").show();sym.getComposition().getStage().$("Feedback").show();sym.getComposition().getStage().$("Next_btn").show();console.log("cornumber = "+cornumber);sym.getComposition().getStage().$("questans").html(cornumber);if(cornumber==8){sym.getComposition().getStage().$("applause")[0].play();sym.getComposition().getStage().$("Next_btn").hide();}
else{sym.getComposition().getStage().$("success1")[0].play();}
sym.stop();});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",5250,function(sym,e){console.log("end of animation");sym.getComposition().getStage().$("failure1")[0].play();sym.getComposition().getStage().$("Feedbackground").stop("wrong");sym.getComposition().getStage().$("Feedbackground").show();sym.getComposition().getStage().$("Feedback").show();sym.getComposition().getStage().$("Next_btn").show();console.log("cornumber = "+cornumber);sym.getComposition().getStage().$("questans").html(cornumber);sym.stop();});
//Edge binding end
...
//Edge symbol: 'back_glow'
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",0,function(sym,e){sym.play();});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",1500,function(sym,e){sym.play(000);});
//Edge binding end
})("back_glow");
//Edge symbol end:'back_glow'
